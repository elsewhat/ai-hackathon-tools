...
namespace AzureOpenAI.Model
{
    ...
    /// </summary>
    [DataContract(Name = "extensionsChatCompletionsRequest")]
    public partial class ExtensionsChatCompletionsRequest : IEquatable<ExtensionsChatCompletionsRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ExtensionsChatCompletionsRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ExtensionsChatCompletionsRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ExtensionsChatCompletionsRequest" /> class.
        /// </summary>
        ...
        /// <param name="dataSources">The data sources to be used for the Azure OpenAI on your data feature..</param>
        public ExtensionsChatCompletionsRequest(decimal? temperature = 1M, decimal? topP = 1M, bool? stream = false, ChatCompletionsRequestCommonStop stop = default(ChatCompletionsRequestCommonStop), int maxTokens = 4096, decimal presencePenalty = 0M, decimal frequencyPenalty = 0M, Object logitBias = default(Object), string user = default(string), List<Message> messages = default(List<Message>), List<DataSource> dataSources = default(List<DataSource>))
        {
            // to ensure "messages" is required (not null)
            if (messages == null)
            {
                throw new ArgumentNullException("messages is a required property for ExtensionsChatCompletionsRequest and cannot be null");
            }
        ...
        /// </summary>
        /// <value>The data sources to be used for the Azure OpenAI on your data feature.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ExtensionsChatCompletionsRequest {\n");
        ...
        {
            return this.Equals(input as ExtensionsChatCompletionsRequest);
        }

        /// <summary>
        /// Returns true if ExtensionsChatCompletionsRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of ExtensionsChatCompletionsRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExtensionsChatCompletionsRequest input)
        {
            if (input == null)
            {
                return false;
