...
namespace AzureOpenAI.Model
{
    ...
    public partial class CreateChatCompletionRequest : IEquatable<CreateChatCompletionRequest>, IValidatableObject
    {
        ...
        public CreateChatCompletionRequest(decimal? temperature = 1M, decimal? topP = 1M, bool? stream = false, ChatCompletionsRequestCommonStop stop = default(ChatCompletionsRequestCommonStop), int maxTokens = 4096, decimal presencePenalty = 0M, decimal frequencyPenalty = 0M, Object logitBias = default(Object), string user = default(string), List<ChatCompletionRequestMessage> messages = default(List<ChatCompletionRequestMessage>), List<ChatCompletionFunctions> functions = default(List<ChatCompletionFunctions>), CreateChatCompletionRequestAllOfFunctionCall functionCall = default(CreateChatCompletionRequestAllOfFunctionCall), int? n = 1)
        {
